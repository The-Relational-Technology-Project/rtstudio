        ...
        <div className="relative max-w-4xl mx-auto px-6 py-20 md:py-32">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              A cozy space for neighbors to craft technology that strengthens community bonds
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            <FeatureCard
              ...
              title="Sidekick"
              description="Your AI companion for exploring ideas and turning dreams into action"
              delay="0.1s"
            />
            <FeatureCard
              icon={<BookOpen className="h-6 w-6" />}
              title="Library"
              description="Stories, prompts, and tools shared by neighbors building together"
              delay="0.2s"
            />
            <FeatureCard
